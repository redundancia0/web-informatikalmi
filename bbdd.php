...
function editar_producto($id_producto, $nombre, $precio, $stock, $imagen, $descripcion) {
    $conn = conectarOracle();
    ...
    if ($imagen != null && $imagen != "") {
        // Si hay una imagen cargada, actualizar con la imagen
        ...
        // Si no hay una imagen cargada, actualizar sin la imagen
        $query = "UPDATE productos
        SET nombre = :p_nombre, 
            precio = :p_precio, 
            stock = :p_stock, 
