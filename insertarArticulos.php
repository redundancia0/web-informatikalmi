...
<div id="ventiladores" style="display:none;">
    ...
    <br>
        ...
        <input type="text" id="NOMBRE" name="NOMBRE" placeholder="Article name" value="<?php echo $producto['NOMBRE']?>">
        <br>
        <label for="PRECIO">Price</label>
        <input type="text" name="PRECIO" id="PRECIO"  placeholder="Article price">
        <br>
        <label for="STOCK">Stock</label>
        <input type="number" name="STOCK" id="STOCK"  placeholder="Article stock">
        <br>
        <label for="IMAGEN">Image</label>
        <input type="file" name="IMAGEN" id="IMAGEN" accept="image/*">
        <br>
        <label for="DESCRIPCION">Description</label>
        <textarea id="DESCRIPCION" name="DESCRIPCION"  placeholder="Description of the article" rows="5" cols="50" maxlength="250"></textarea>
        <br>
        <input type="submit" id="singup" value="Insert">
    </form>
<?php
